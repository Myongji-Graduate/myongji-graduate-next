...
export default function TableWithModal<T extends ListRow>({ children, renderModal, onClick }: TableWithModalProps<T>) {
  const [selected, setSelected] = useState<T | null>(null);
  const { open, close } = useDialog(DIALOG_KEY.LECTURE_INSIGHT);
