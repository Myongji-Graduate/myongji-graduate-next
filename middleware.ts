...
const allowedGuestPath = ['/', '/tutorial', '/anonymous', '/anonymous/result', '/subjects', ...allowedOnlyGuestPath];
const allowInitUserPath = ['/', '/tutorial', '/grade-upload', '/anonymous', '/anonymous/result', '/subjects'];
